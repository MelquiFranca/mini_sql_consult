...
ipcMain.handle('SalvarConexao', (evento, data) => ipcService.salvarConexao(evento, data, dataBaseLocal))
ipcMain.handle('ExibeMenuContexto', (evento, data) => ipcService.exibeMenuContexto(evento, data))
